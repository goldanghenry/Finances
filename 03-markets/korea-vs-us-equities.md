...
쉽게 말하면: 한국 대형주의 PBR 0.5배는 “자산 대비 주가가 싸다”는 뜻이지만, 그 자산이 실제로 주주에게 돌아올지가 불확실한 경우가 많다(지배구조 이슈). 미국의 PER 30배는 비싸 보이지만 매년 20~25% 성장하는 기업이라면 성장가치가 반영된 것일 수 있다. 주의할 점: 단순 PER·PBR로 “한국이 싸다, 미국이 비싸다”는 결론을 내리기 전에 **업종 구성, 성장률, 주주환원 수준**을 함께 봐야 한다.
