...
| \(D_{Mac}\) | D Mac | 본문 §4·위 식 맥락 참고 |
| \(CF_t\) | t기 현금흐름 | 유입 +, 유출 − (관례 확인) |
| \(D_{mod}\) | D mod | 본문 §4·위 식 맥락 참고 |
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(YTM_{corp}\) | YTM corp | 본문 §4·위 식 맥락 참고 |
| \(YTM_{gov}\) | YTM gov | 본문 §4·위 식 맥락 참고 |
