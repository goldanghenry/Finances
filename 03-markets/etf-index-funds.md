...
|  \(투자자\)  |  투자자  | 본문 §4·위 식 맥락 참고 |
|  \(지수\)  |  지수  | 본문 §4·위 식 맥락 참고 |
|  \(TER\)  |  TER  | 본문 §4·위 식 맥락 참고 |
| \(추적오차\) | 추적오차 | 지수 대비 **수익률 차이** |
|  \(세금\)  |  세금  | 본문 §4·위 식 맥락 참고 |
|  \(괴리 비용\)  |  괴리 비용  | 본문 §4·위 식 맥락 참고 |
\[
...
| 항목 | 상품 A | 상품 B |
|------|--------|--------|
|  추종 지수  | 추종 지수 | 본문 §4·위 식 맥락 참고 |
|  TER  | TER | 본문 §4·위 식 맥락 참고 |
|  AUM·거래대금  | AUM·거래대금 | 본문 §4·위 식 맥락 참고 |
|  환헷지  | 환헷지 | 본문 §4·위 식 맥락 참고 |
|  계좌(ISA 등)  | 계좌(ISA 등) | 본문 §4·위 식 맥락 참고 |
|  3년 누적 추적오차  | 3년 누적 추적오차 | 본문 §4·위 식 맥락 참고 |
