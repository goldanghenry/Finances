...
|   \(달러\)   | \(달러\) | \(달러\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(E_{\text{Mag7}}\)  |  E \textMag7  | \(E \textMag7\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{\text{S&P}}\)  |  w \textS&P  | \(w \textS&P\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(s_{\text{S&P}}\)  |  s \textS&P  | \(s \textS&P\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{\text{QQQ}}\)  |  w \textQQQ  | \(w \textQQQ\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(s_{\text{NDX}}\)  |  s \textNDX  | \(s \textNDX\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{\text{개별}}\)  |  w \text개별  | \(w \text개별\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{투자자}}\)  |  R \text투자자  | \(R \text투자자\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{지수}}\)  |  R \text지수  | \(R \text지수\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
