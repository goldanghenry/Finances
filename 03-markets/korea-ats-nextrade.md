...
|             \(fill\)             | fill | fill이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(NXT\) | 넥스트레이드 | 국내 대표 ATS 운영·시장 명칭 |
|             \(KRX\)             | KRX | KRX이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \((매수 시, 호가에 따라)\)   |   (매수 시, 호가에 따라)   | \((매수 시, 호가에 따라)\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{net}}\)  |  R \textnet  | \(R \textnet\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{gross}}\)  |  R \textgross  | \(R \textgross\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
