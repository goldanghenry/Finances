...
|  \(fill\)  |  fill  | 본문 §4·위 식 맥락 참고 |
| \(NXT\) | 넥스트레이드 | 국내 대표 ATS 운영·시장 명칭 |
|  \(KRX\)  |  KRX  | 본문 §4·위 식 맥락 참고 |
|  \((매수 시, 호가에 따라)\)  |  (매수 시, 호가에 따라)  | 본문 §4·위 식 맥락 참고 |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(R_{\text{net}}\) | R \textnet | 본문 §4·위 식 맥락 참고 |
| \(R_{\text{gross}}\) | R \textgross | 본문 §4·위 식 맥락 참고 |
