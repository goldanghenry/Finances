...
|  \(D_1\)  |  D_1  | 본문 §4·위 식 맥락 참고 |
|  \(r\)  |  r  | 기간당 이자·요구수익률 |
|  \(P_1\)  |  P_1  | 본문 §4·위 식 맥락 참고 |
\[
...
| \(FCF_{n\) | FCF n | 본문 §4·위 식 맥락 참고 |
| \(g_{term}\) | g term | 본문 §4·위 식 맥락 참고 |
| \(V\) | V | 본문 §4·위 식 맥락 참고 |
...
EV=1조, EBITDA=500억 → **20x**. 동종 12x → **프리미엄** — **성장·마진** 근거 없으면 **상대 고평가**.
