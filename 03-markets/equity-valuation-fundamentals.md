...
**고성장** \(t=1..n\) 을 명시 예측, **터미널**은 **\(g_{term}\)** (보통 **명목 GDP
...
**식 (기호)**: 1. **정의**: **r_E**, **r_f**, **R_m**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다. 2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다. **한국**: **국채 3~10년**, **베타**는 **KOSPI**·동종 — **유동성·지배** 프리미엄을 **교육적으로** 별도 논의.
