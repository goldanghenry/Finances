...
|   \(r_{\mathrm{ETF}\)   |   r_{\mathrm{ETF}   | \(r \mathrmETF\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(r_{\mathrm{index}\)   |   r_{\mathrm{index}   | \(r \mathrmindex\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \((TR 또는 PR 규격)\)   |   (TR 또는 PR 규격)   | \((TR 또는 PR 규격)\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(f_{\mathrm{TER}\)   |   f_{\mathrm{TER}   | \(f \mathrmTER\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \((연율 근사)\)   | \((연율 근사)\) | \((연율 근사)\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(c_{\mathrm{tx}\)   |   c_{\mathrm{tx}   | \(c \mathrmtx\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \((거래·스프레드·FX)\)   |   (거래·스프레드·FX)   | \((거래·스프레드·FX)\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
**유도 (L4)**:
1. **정의**: **r_**, **r_**, **TR**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
