...
|   \(KRW, unhedged\)   |   KRW, unhedged   | \(KRW, unhedged\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(USD asset\)   |   USD asset   | \(USD asset\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
**유도 (L4)**:
1. **정의**: **R_**, **KRW**, **USD**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
...
| 기호 | 이름 | 이 식에서 의미 |
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{KRW}}\)  |  R \textKRW  | \(R \textKRW\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{USDasset}}\)  |  R \textUSDasset  | \(R \textUSDasset\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{FX}}\)  |  R \textFX  | \(R \textFX\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
**유도 (L4)**:
1. **정의**: **R_**, **R_**, **R_**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{\text{USDasset}}\)  |  R \textUSDasset  | \(R \textUSDasset\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(c_{\text{hedge}}\)  |  c \texthedge  | \(c \texthedge\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(f_{\text{TER}}\)  |  f \textTER  | \(f \textTER\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\delta_{\text{repl}}\)  |  \delta \textrepl  | \(\delta \textrepl\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(TER\)             | TER | TER이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
**읽는 법**: **R_**와 **c_**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **R_**, **c_**, **f_**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\delta_{\text{repl}}\)  |  \delta \textrepl  | \(\delta \textrepl\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(D_{\text{gross}}\)  |  D \textgross  | \(D \textgross\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\tau_{\text{WHT}}\)  |  \tau \textWHT  | \(\tau \textWHT\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(TER\)             | TER | TER이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
**읽는 법**: **D_**와 **tau_**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **D_**, **tau_**, **D**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
| 기호 | 이름 | 이 식에서 의미 |
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_{\text{sell,KRW}}\)  |  P \textsell,KRW  | \(P \textsell,KRW\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_{\text{buy,KRW}}\)  |  P \textbuy,KRW  | \(P \textbuy,KRW\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
**유도 (L4)**:
1. **정의**: **P_**, **P_**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
| 기호 | 이름 | 이 식에서 의미 |
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_{\text{buy,KRW}}\)  |  P \textbuy,KRW  | \(P \textbuy,KRW\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(e_{\text{buy}}\)  |  e \textbuy  | \(e \textbuy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_{\text{sell,KRW}}\)  |  P \textsell,KRW  | \(P \textsell,KRW\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(e_{\text{sell}}\)  |  e \textsell  | \(e \textsell\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
**유도 (L4)**:
1. **정의**: **P_**, **e_**, **P_**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
