...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(ROI\)  |  ROI  | 본문 §4·위 식 맥락 참고 |
|  \(절감 인건비\)  |  절감 인건비  | 본문 §4·위 식 맥락 참고 |
|  \(품질·가동 이득\)  |  품질·가동 이득  | 본문 §4·위 식 맥락 참고 |
|  \(유지·전력\)  |  유지·전력  | 본문 §4·위 식 맥락 참고 |
|  \(로봇·설치 CAPEX\)  |  로봇·설치 CAPEX  | 본문 §4·위 식 맥락 참고 |
\[
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
- DoF **30**, 감속기 **200만 원×30** = **6,000만 원** (가상) — **양산** 전 **단가** 불확실
