...
|             \(ROI\)             | ROI | ROI이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(절감 인건비\)   | \(절감 인건비\) | \(절감 인건비\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(품질·가동 이득\)   | \(품질·가동 이득\) | \(품질·가동 이득\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(유지·전력\)   | \(유지·전력\) | \(유지·전력\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(로봇·설치 CAPEX\)   |   로봇·설치 CAPEX   | \(로봇·설치 CAPEX\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
