...
|             \(PEG\)             | PEG | PEG이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(PER\)   | 주가수익비율 | 주가 ÷ EPS |
|   \(EPS 성장률(\%)\)   |   EPS 성장률(\%)   | \(EPS 성장률(\%)\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
|   **국내주 세금**   |   ISA 밖 일반계좌 — [domestic-stocks-tax.md](../../06-korea-policy/tax/domestic-stocks-tax.md)   | **국내주 세금**이(가) 이 식에서 맡는 역할(§4·본문 참고) |
