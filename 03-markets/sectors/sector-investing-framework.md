...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(PEG\)  |  PEG  | 본문 §4·위 식 맥락 참고 |
|  \(PER\)  |  PER  | 주가 ÷ EPS |
|  \(EPS 성장률(\%)\)  |  EPS 성장률(\%)  | 본문 §4·위 식 맥락 참고 |
\[
...
|  **국내주 세금**  |  ISA 밖 일반계좌 — [domestic-stocks-tax.md](../../06-korea-policy/tax/domestic-stocks-tax.md)  | 본문 §4·위 식 맥락 참고 |
