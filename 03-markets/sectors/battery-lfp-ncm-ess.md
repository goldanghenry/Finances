...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(Pack cost\)  |  Pack cost  | 본문 §4·위 식 맥락 참고 |
|  \(Cell cost\)  |  Cell cost  | 본문 §4·위 식 맥락 참고 |
| \(BMS\) | 배터리관리시스템 | 충방전·열·안전 제어 |
|  \(구조·열관리\)  |  구조·열관리  | 본문 §4·위 식 맥락 참고 |
|  \(마진\)  |  마진  | 본문 §4·위 식 맥락 참고 |
\[
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
- 가동률 **<70%** 구간에서 **영업적자** 전환 빈번 (가상 CAPEX 과잉 시)
...
|------------|-----------|--------|------|
| **저가 EV Z** | 3,000만 원급 | **LFP** | 원가·수명 |
| **프리미엄 P** | 6,000만 원급 | **NCM 811** | 주행거리 |
...
| 가상 전해액 코스피 | 500만 원 | 10% | 4 |
| 가상 코스닥 장비 | 500만 원 | 10% | 4 |
