...
|   \(Pack cost\)   |   Pack cost   | \(Pack cost\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(Cell cost\)   |   Cell cost   | \(Cell cost\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(BMS\) | 배터리관리시스템 | 충방전·열·안전 제어 |
|   \(구조·열관리\)   | \(구조·열관리\) | \(구조·열관리\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(마진\)   | \(마진\) | \(마진\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
