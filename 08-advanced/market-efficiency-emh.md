...
|  \(E\)  |  E  | 본문 §4·위 식 맥락 참고 |
|  \(mid\)  |  mid  | 본문 §4·위 식 맥락 참고 |
|  \(mathcal\)  |  mathcal  | 본문 §4·위 식 맥락 참고 |
|  \(I\)  |  I  | 본문 §4·위 식 맥락 참고 |
|  \(weak\)  |  weak  | 본문 §4·위 식 맥락 참고 |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(R_{i\) | R i | 본문 §4·위 식 맥락 참고 |
| \(pha_i\) | pha i | 본문 §4·위 식 맥락 참고 |
| \(eta_i\) | eta i | 본문 §4·위 식 맥락 참고 |
| \(R_{m\) | R m | 본문 §4·위 식 맥락 참고 |
| \(\sum_k\) | sum k | 본문 §4·위 식 맥락 참고 |
| \(mma_{i\) | mma i | 본문 §4·위 식 맥락 참고 |
