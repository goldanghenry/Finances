...
|             \(mid\)             | mid | mid이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(mathcal\)             | mathcal | mathcal이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(I\)             | I | I이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(weak\)             | weak | weak이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{i\)  |  R i  | \(R i\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(pha_i\)  |  pha i  | pha i이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(eta_i\)  |  eta i  | eta i이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{m\)  |  R m  | \(R m\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\sum_k\)  |  sum k  | sum k이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(mma_{i\)  |  mma i  | \(mma i\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 정보 | 형태 | EMH |
|------|------|----------------|
|  작년 주가 차트  | 작년 주가 차트 | 작년 주가 차트이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  어제 DART 실적  | 어제 DART 실적 | 어제 DART 실적이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  미공개 M&A  | 미공개 M&A | 미공개 M&A이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  애널 consensus  | 애널 consensus | 애널 consensus이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  Fed 금리 결정  | Fed 금리 결정 | Fed 금리 결정이(가) 이 식에서 맡는 역할(§4·본문 참고) |
