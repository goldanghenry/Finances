...
|   \(EPS_\)   | EPS  | EPS 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(pro forma\)   |   pro forma   | \(pro forma\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(NI_A\)   | NI A | NI A이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(NI_T\)   | NI T | NI T이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(V_{\text{synergy}}\)  |  V \textsynergy  | \(V \textsynergy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
| 시총 | 10조 | 2조 |
| 순이익 | 8,000억 | 1,000억 |
|   제안   |   **프리미엄 30%**   | 제안이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   대가   |   **현금 50%·주식 50%**   | 대가이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   비용 시너지(연)   |   **300억**(가정, 3년 후 **풀**)   | 비용 시너지(연)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
