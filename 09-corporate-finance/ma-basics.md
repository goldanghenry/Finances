...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(EPS_\)  |  EPS_  | 본문 §4·위 식 맥락 참고 |
|  \(pro forma\)  |  pro forma  | 본문 §4·위 식 맥락 참고 |
|  \(NI_A\)  |  NI_A  | 본문 §4·위 식 맥락 참고 |
|  \(NI_T\)  |  NI_T  | 본문 §4·위 식 맥락 참고 |
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(V_{\text{synergy}}\) | V \textsynergy | 본문 §4·위 식 맥락 참고 |
...
| 시총 | 10조 | 2조 |
| 순이익 | 8,000억 | 1,000억 |
|  제안  |  **프리미엄 30%**  | 본문 §4·위 식 맥락 참고 |
|  대가  |  **현금 50%·주식 50%**  | 본문 §4·위 식 맥락 참고 |
|  비용 시너지(연)  |  **300억**(가정, 3년 후 **풀**)  | 본문 §4·위 식 맥락 참고 |
...
타겟 EBITDA **500억**, Multiple **8x** → EV **4,000억**, 순부채 **500억** → **주식가치 3,500억**.
...
지불 **4,000억**, **순자산** **공정가치 2,500억** → **영업권 1,500억** — **향후** **손상차손** **리스크**.
