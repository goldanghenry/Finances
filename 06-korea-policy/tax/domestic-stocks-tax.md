...
|   \(domestic CGT\)   |   domestic CGT   | \(domestic CGT\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(비과세\)   | \(비과세\) | \(비과세\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(D_{\text{domestic}}\)  |  D \textdomestic  | \(D \textdomestic\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(D_{\text{foreign}}\)  |  D \textforeign  | \(D \textforeign\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|   본 저장소 기본 독자   |   **후자** 문서 + [investment-tax-overview](investment-tax-overview.md)   | 본 저장소 기본 독자이(가) 이 식에서 맡는 역할(§4·본문 참고) |
