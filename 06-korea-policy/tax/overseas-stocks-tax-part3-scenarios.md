...
| \(\IRP\) | IRP | 본문 §4·위 식 맥락 참고 |
| \(\u_\text{eff}\) | u  eff | 본문 §4·위 식 맥락 참고 |
| \(\T_\text{ISA}\) | T  ISA | 본문 §4·위 식 맥락 참고 |
| \(\T_\text{IRP}\) | T  IRP | 본문 §4·위 식 맥락 참고 |
| \(\T_\text{gen}\) | T  gen | 본문 §4·위 식 맥락 참고 |
| \(\G_\text{total}\) | G  total | 본문 §4·위 식 맥락 참고 |
