...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(FV\)  |  FV  | 미래 시점의 목표·결과 금액 |
|  \(PMT\)  |  PMT  | 매 기간 동일하게 넣거나 받는 금액 |
|  \(r\)  |  r  | 기간당 이자·요구수익률 |
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
- 공제율: 총급여·종합소득 구간에 따라 **16.5% / 13.2% / 9.9%** 등 (연금저축·IRP 규정)  
...
|------|---------------|-----|----------------------|
| DB | 회사만 적립, 본인 조작 없음 | — | 추계 퇴직금 3,000만 원 |
...
| 일시금 | 4,000만 원 수령 | 퇴직소득세 후 **현금** — 소비·복리 상실 위험 |
