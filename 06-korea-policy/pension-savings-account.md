...
|   \(절세\)   | \(절세\) | \(절세\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(근사\)   | \(근사\) | \(근사\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(적격 납입액\)   | \(적격 납입액\) | \(적격 납입액\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(L_\)   | L  | L 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(year\)             | year | year이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|  \(\sum_{t\)  |  \sum t  | \(\sum t\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_t\)  |  P t  | P t이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(FV_{\text{net}}\)  |  FV \textnet  | \(FV \textnet\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\sum_{t\)  |  \sum t  | \(\sum t\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(P_t\)  |  P t  | P t이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
