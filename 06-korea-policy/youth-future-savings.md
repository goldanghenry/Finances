...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(만기 수령액\)  |  만기 수령액  | 본문 §4·위 식 맥락 참고 |
|  \(t\)  |  t  | 마지막 CF 시점 |
|  \(T\)  |  T  | 마지막 CF 시점 |
|  \(P_\)  |  P_  | 본문 §4·위 식 맥락 참고 |
|  \(cdot\)  |  cdot  | 본문 §4·위 식 맥락 참고 |
|  \(r_{\text{eff}\)  |  r_{\text{eff}  | 본문 §4·위 식 맥락 참고 |
...
|------|-------------------------------|--------------------------------|
| 도약 잔여 | 38개월 | 6개월 |
| 미래적금 우대형 기여 가정 | 월 50만 × 36개월 + 12% 기여 | 동일 |
...
|------|--------|
| 월 소득(가상) | 320만 원 |
| 미래적금 납입 | 월 **30만 원** (3년 유지 가능 수준) |
| 3년 원금 | 1,080만 원 |
| 정부기여+이자(가상) | 구간별 — kinfa 계산기로 확인 |

→ **무리한 70만 원** 납입 후 중도해지가 최대 리스크.
