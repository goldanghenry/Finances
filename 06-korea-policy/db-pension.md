...
|   \(퇴직금\)   | \(퇴직금\) | \(퇴직금\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(평균임금\)   | \(평균임금\) | \(평균임금\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(근속연수\)   | \(근속연수\) | \(근속연수\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(지급률\)   | \(지급률\) | \(지급률\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
|------|-----|
| 가상 직장인 A | 근속 5년 |
| 최근 3개월 평균 임금 | 월 **M** (만 원 단위, 교육용) (가상) |
