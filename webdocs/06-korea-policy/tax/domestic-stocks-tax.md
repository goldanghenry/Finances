...
**쉽게 말하면:** 일반 개인이 삼성전자나 코스피 ETF를 팔아서 이익이 나도 양도세는 없습니다. 그러나 **배당금**을 받으면 금융소득으로 세금이 붙습니다. 연간 금융소득이 2,000만 원을 넘으면 5월에 종합과세를 합니다.

**핵심은:** 국내주식 매매차익은 비과세(일반 개인 원칙)이지만, 배당소득은 금융소득에 포함됩니다. **해외주식 매매차익은 별도 양도세(22%)** — 이 두 가지를 헷갈리면 안 됩니다.

**주의:** NXT(넥스트레이드)에서 거래해도 국내 상장주식이면 세금 규칙은 KRX와 동일합니다. “NXT는 세금이 다르다”는 잘못된 정보입니다.

**예를 들어:** 삼성전자를 매도해 500만 원 차익이 생겨도 일반 개인은 양도세 0원(원칙). 하지만 삼성전자 배당금 300만 원을 받으면 금융소득에 합산됩니다. 여기에 이자소득 등 다른 금융소득까지 더해 연 2,000만 원 초과 시 종합과세 대상입니다.
...
| 국내 배당 | **M** |
| 해외 배당 | **M** |
| 합계 | **M** → [part2](overseas-stocks-tax-part2-dividend.md) |
