...
|  \(\IRP\)  | IRP | §4 용어·식 맥락에서 확인 |
|  \(\u_\text{eff}\)  |  u  eff  | §4 용어·식 맥락에서 확인 |
|  \(\T_\text{ISA}\)  |  T  ISA  | §4 용어·식 맥락에서 확인 |
|  \(\T_\text{IRP}\)  |  T  IRP  | §4 용어·식 맥락에서 확인 |
|  \(\T_\text{gen}\)  |  T  gen  | §4 용어·식 맥락에서 확인 |
|  \(\G_\text{total}\)  |  G  total  | §4 용어·식 맥락에서 확인 |
\[
