...
| 기호 | 이름 | 이 식에서 의미 |
|        ------        | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(S_{\text{ISA}}\)  |  S \textISA  | \(S \textISA\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(G\)             | G | G이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(H\)             | H | H이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| | 가상 W | 3년 QQQ 차익 **M** |
|--|--------|---------------------|
|   ISA   |   한도 200만 비과세+초과 9.9%   | ISA이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   IRP   |   **이연** — 수령 시   | IRP이(가) 이 식에서 맡는 역할(§4·본문 참고) |
### 예제 2: 공제 (가상)
