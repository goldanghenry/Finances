...
**쉽게 말하면:** 세금 계획의 핵심은 **어떤 투자를 어느 계좌에서 하느냐**입니다. 같은 QQQ ETF라도:
- **일반 계좌** → 해외주식 양도세 22% + 매년 5월 신고
- **ISA(3년)** → 비과세 한도 내 0%, 초과분 9.9% 분리과세
- **IRP** → 과세이연, 수령 시 연금소득세

**핵심은:** 세금 계산 단계를 기억하세요.
1. **소득 유형 확인**: 매매차익(양도) vs 이자·배당(금융소득)
2. **국내 vs 해외**: 국내 상장 ETF 매매차익은 비과세 원칙, 해외는 22%
3. **계좌 유형**: ISA·IRP·DC는 각자 별도 세제
4. **신고 필요 여부**: 해외주식 양도세는 매년 5월 신고 필수

**주의:** 이자·배당 소득이 연 2,000만 원을 초과하면 5월 종합과세 대상입니다. 배당 ETF를 많이 보유하면 이 기준에 주의해야 합니다.
...
flowchart TD
  ...
  O --> CGT["양도소득세 22%"]
  Fin --> Limit{"연 2000만원"}
  Limit -->|초과| May["5월 종합과세"]
  Limit -->|이하| Sep["분리과세 경로"]
```
...
**식 (기호)**: 금융소득 합계 > 20{,}000{,}000 5월 종합과세 검토
...
NDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.---
...
**Q9. 해외주식 양도차익과 배당을 합산해서 신고하나요?**  
**A9.** **아닙니다.** 양도차익은 양도소득세(5월 신고), 배당은 금융소득으로 별도 처리됩니다. 두 유형은 서로 통산·상쇄가 되지 않습니다. [part1](overseas-stocks-tax-part1-cgt.md)·[part2](overseas-stocks-tax-part2-dividend.md) 참고.

**Q10. 연간 금융소득이 얼마부터 종합과세인가요?**  
**A10.** 이자+배당 합산 **연 2,000만 원 초과** 시 다른 소득과 합산해 종합과세합니다. 2,000만 원 이하는 원천징수로 분리과세 종결됩니다. 배당 ETF 보유가 많아지면 이 기준에 주의해야 합니다.
