...
|             \(begin\)             | begin | begin이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(cases\)             | cases | cases이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(alpha\)             | alpha | alpha이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(ge\)             | ge | ge이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(lambda\)             | lambda | lambda이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(beta\)   | 베타 | 시장 대비 민감도 |
\[
v(x) = \begin{cases}
x^\alpha & x \ge 0 \\
