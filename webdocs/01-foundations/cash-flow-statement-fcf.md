...
| \(OCF\) | Operating Cash Flow | 영업활동 순현금흐름 |
|             \(NI\)             | NI | NI이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(D\)             | D | D이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(A\)             | A | A이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(Delta\)             | Delta | Delta이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(NWC\)             | NWC | NWC이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(기타 비현금 조정\)   | \(기타 비현금 조정\) | \(기타 비현금 조정\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(CAPEX_{\text{gross}}\)  |  CAPEX \textgross  | \(CAPEX \textgross\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|  \(CFF_t}\)  |  CFF t  | \(CFF t\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
