...
|------|------|----------------|
| \(유동비율\) | Current ratio | 유동자산 ÷ 유동부채 |
| \(유동자산\) | 유동자산 | §4·본문 정의 참고 |
| \(유동부채\) | 유동부채 | §4·본문 정의 참고 |
| \(당좌비율\) | Quick ratio |  |
| \(재고\) | 재고 | §4·본문 정의 참고 |
| \(선급비용 등\) | 선급비용 등 | §4·본문 정의 참고 |
...
배당·상환 여력은 [cash-flow-basics](cash-flow-basics.md)와 연계. **성장 CAPEX**가 큰 [battery-lfp-ncm-ess](../03-markets/sectors/battery-lfp-ncm-ess.md)는 **FCF 마이너스**가 “나쁨”만은 아니다 — **투자 주기·수주**와 함께 본다.
