...
**이 개념을 모르면 생기는 실수:**
- IR 홍보 자료의 "AI 수요 폭발, 매출 급증"만 믿고 투자했는데 DART 사업보고서의 현금흐름표는 계속 마이너스였다.
- 주석을 읽지 않아 "영업이익 30% 증가" 중 대부분이 일회성 자산 처분 이익이었다는 것을 몰랐다.
- 사업보고서가 3~4개월 지연 제출된다는 것을 몰라 "작년 연간" 데이터로 오늘 투자 결정을 내렸다.
...
**DART = 법원 기록실, IR = 회사 홍보 브로슈어**: 법원 기록은 **형식·감사·지연 규칙**이 있다. 브로슈어는 **읽기 쉽고 전망이 밝다** — 둘 다 보되, **분쟁 시 기록실**이 기준이다. 예를 들어, 직장인 A씨가 회사의 IR 자료를 보고 "AI 수요 폭발, 매출 급증"을 믿고 투자했는데, 정작 DART 사업보고서의 현금흐름표는 계속 마이너스였다면 IR 자료에 속은 것이다.

**사업보고서 = 연간 백과사전**: 200~400페이지도 흔하다. 처음부터 끝까지 읽지 않는다. **목차·재무제표·주석·위험요인·감사의견**만 **정해진 루트**로 훑는다. 쉽게 말하면, 색인과 주석만 잘 봐도 핵심 정보의 80%는 잡힌다.

**주석 = 계약서 각주**: 본문 표의 "매출 1조"가 **어떤 인식 기준**으로 잡혔는지, **관계회사 매출**이 섞였는지, **소송**으로 얼마가 나갈 수 있는지는 **각주(주석)** 에 있다. 예를 들어, 직장인 B씨가 "영업이익 30% 증가"만 보고 매수했는데, 주석에 "일회성 자산 처분이익 포함"이라고 적혀 있었다면 반복되는 이익이 아님을 알 수 있었을 것이다.

**MD&A = CEO의 "왜 그랬는지" 에세이**: 숫자 **원인·전략·리스크** 서술. 에세이는 **선택적 강조**가 가능하다 — "AI 수요 호조" 문단 옆에 **영업CF 감소**가 없는지 [cash-flow-basics](cash-flow-basics.md)로 대조한다.
...
|------|------|------|----------------|
| DART | 금융감독원 **전자공시** 시스템 | §4 | [glossary](../00-roadmap/glossary.md#dart) |
| 사업보고서 | 사업연도 종료 후 **연간** 종합 공시 | §4 | [glossary](../00-roadmap/glossary.md#사업보고서) |
| 분기·반기보고서 | **더 잦은** 재무·주요 사항 | §4 | [glossary](../00-roadmap/glossary.md#분기·반기보고서) |
| 주요사항보고서 | 합병·유상증자·CB·소송 등 **수시** | §4 | [glossary](../00-roadmap/glossary.md#주요사항보고서) |
| 재무제표 주석 | 회계정책·세부 금액·우발·세그먼트 | §4 | [glossary](../00-roadmap/glossary.md#재무제표-주석) |
| MD&A | 경영진의 **재무·영업·위험** 논의·분석 | §4 | [glossary](../00-roadmap/glossary.md#md&a) |
| 사업의 내용 | 한국 사업보고서 내 **사업·시장·전략** | §4 | [glossary](../00-roadmap/glossary.md#사업의-내용) |
| 연결·개별 | 그룹 vs 모회사 단독 | §4 | [glossary](../00-roadmap/glossary.md#연결·개별) |
| 감사의견 | 적정·한정·부적정·의견거절 | §4 | [glossary](../00-roadmap/glossary.md#감사의견) |
| 계속기업 가정 | 12개월 내 **지속 가능** 가정 | §4 | [glossary](../00-roadmap/glossary.md#계속기업-가정) |
| 비GAAP | 조정 EBITDA·조정 EPS 등 **공시 외** 지표 | §4 | [glossary](../00-roadmap/glossary.md#비gaap) |
| 가이던스 | 향후 매출·마진 **전망** | §4 | [glossary](../00-roadmap/glossary.md#가이던스) |
| XBRL·전자공시 | 표 **단위·태그** | §4 | [glossary](../00-roadmap/glossary.md#xbrl·전자공시) |
| 특수관계자 | 계열·임원·지배주주 등 | §4 | [glossary](../00-roadmap/glossary.md#특수관계자) |
...
**유도 (L4)**:
1. **정의**: **자산**, **부채**, **자본**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
...
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
- **지속적으로** \( \text{OCF} / \text{NI} < 1 \) 이면이익이 **외상·재고·비현금**에 묶였을 가능성 — [cash-flow-basics](cash-flow-basics.md).
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| **r** | 할인율·수익률 | 기간당 이자·요구수익률 |
| **n** | 기간 | 연·월 등 복리·할인에 쓰는 횟수 |
...
**읽는 법**: **m_i**와 **OP_i**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **m_i**, **OP_i**, **Rev_i**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
...
정의**: **r**, **n**, **PV**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
...
\[
\Delta \text
{이자} \approx r_{\text{변동}} \times \Delta r \times \text{변동금리부채}
\]

**식 (기호)**: **Δ**_ {이자} ≈ r_변동 ×**Δ**_ **r** ×변동금리부채
...
**읽는 법**: **r_**와 **PV**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **r_**, **PV**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| **r** | 할인율·수익률 | 기간당 이자·요구수익률 |
...
\[
ROE = \
frac{\text{순이익}}{\text{자본}} = \underbrace{\frac{\text{순이익}}{\text{매출}}}_{\text{순이익률}} \times \underbrace{\frac{\text{매출}}{\text{자산}}}_{\text{자산회전}} \times \underbr
ace{\frac{\text{자산}}{\text{자본}}}_{\text{레버리지}}
\]


**읽는 법**: **ROE**와 **PV**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **ROE**, **PV**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
...
../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
...
\[
PER = \frac{P}{\text{EPS}}, \quad \text{EPS}_{\text{조정}} = \frac{\text{순이익} - \text{일회성} + \text{IR조정항}
}{\text{가중평균주식수}}
\]
...
**읽는 법**: **PV**와 **ROE**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **PV**, **ROE**, **PER**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| **PV** | 현재가치 | 오늘 시점으로 환산한 금액 |
...
**읽는 법**: **PER_**와 **PV**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **PER_**, **PV**, **EPS**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
...
**읽는 법**: **t_**와 **t_1**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **t_**, **t_1**, **t_2**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| **PV** | 현재가치 | 오늘 시점으로 환산한 금액 |
...
식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
...
**A.** **쉽게 말하면:** 1) 연간사업보고서(12월 결산 → 3월 제출) → 2) 분기·반기보고서 → 3) 주요사항보고서(유상증자·자사주매입 등 이벤트성). 처음이라면 보유 ETF의 **구성 비중 1위 종목**의 반기보고서 재무제표만 읽어도 큰 도움이 된다.
