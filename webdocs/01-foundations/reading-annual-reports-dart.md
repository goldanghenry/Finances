...
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
 ...
 이익이 **외상·재고·비현금**에 묶였을 가능성 — [cash-flow-basics](cash-flow-basics.md).
...
t-and-interest](debt-and-interest.md), [macro-02-money-inflation](../02-economics/macro-02-money-inflation.md).
...
고일수 **급증** + 매출 성장 = **수익 인식·채널 stuffing** 의심 — [financial-statements-intro](financial-statements-intro.md) 예제 1과 동형.
...
IR의 “조정 EPS”가 **주석에 없는 항목**을 빼면 \( PER_{\text{조정}} \ll PER_{\text{공시}} \) 착시 — [financial-statements-intro](financial-statements-i
|   이름   |   이 식에서 의미   | §4 용어·식 맥락에서 확인 |
| 기호 | 이름 | 이 식에서 의미 |
|    ------    | ------ | 위 식의 ------ |
ntro.md) 예제 4.
