...
|   \(w_{core}\)   |   w_{core}   | \(w core\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(w_{sat}\)   |   w_{sat}   | \(w sat\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(lta_{sell\)  |  lta sell  | \(lta sell\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{sat\)  |  w sat  | \(w sat\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|            \(V\)            | V | V이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
|  \(FV_{core}\)  |  FV core  | \(FV core\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
