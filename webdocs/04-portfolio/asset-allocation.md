...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(sigma\) | sigma | §4·본문 정의 참고 |
| \(p\) | p | §4·본문 정의 참고 |
| \(sqrt\) | sqrt | §4·본문 정의 참고 |
| \(w\) | w | §4·본문 정의 참고 |
| \(s\) | s | §4·본문 정의 참고 |
| \(b\) | b | §4·본문 정의 참고 |
| \(rho\) | rho | §4·본문 정의 참고 |
...
| 자산군 | 목표 | 금액 (순자산 5,000만) | 상품 (가상) |
|--------|------|----------------------|-------------|
| 주식 60% | 3,000만 | QQQ 1,500만 + 글로벌 1,500만 |
| 채권 35% | 1,750만 | 국채 ETF |
| 현금 5% | 250만 | MMF |
...
| 슬롯 | 배분 | 비고 |
|------|------|------|
| DB (2a) | **본인 조정 불가** | 추계 2,000만 |
| ISA (2b~3) | 60/40 실행 | 월 80만 DCA |
| 위성 | 주식군 **내 15% 상한** 아님 — **전체 15%** — [core-satellite](core-satellite-framework.md) |
...
| 자산군 | 비중 | 구성 | 논리 (교육) |
|--------|------|------|-------------|
| 주식 70% | QQQ 35% + 글로벌 25% + 국내 10% | **tech 임금**과 **포트 tech** **이중** — 글로벌·채권으로 완충 |
