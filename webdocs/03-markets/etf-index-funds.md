...
|   \(투자자\)   | \(투자자\) | \(투자자\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(지수\)   | \(지수\) | \(지수\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(TER\)             | TER | TER이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(추적오차\)  | \(추적오차\) | \(추적오차\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(세금\)   | \(세금\) | \(세금\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(괴리 비용\)   | \(괴리 비용\) | \(괴리 비용\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 항목 | 상품 A | 상품 B |
|------|--------|--------|
|   추종 지수   | 추종 지수 | 추종 지수이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   TER   | TER | TER이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   AUM·거래대금   | AUM·거래대금 | AUM·거래대금이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   환헷지   | 환헷지 | 환헷지이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   계좌(ISA 등)   | 계좌(ISA 등) | 계좌(ISA 등)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   3년 누적 추적오차   | 3년 누적 추적오차 | 3년 누적 추적오차이(가) 이 식에서 맡는 역할(§4·본문 참고) |
