...
| **선수** | [STUDY-START](../../00-roadmap/STUDY-START.md), [time-horizon-and-buckets](../../04-portfolio/time-horizon-and-buckets.md) |
...
| 5-step | [sector-investing-framework.md] | §4 | [glossary](../../00-roadmap/glossary.md#5-step) |
| Core | Bucket **3** ETF | §4 | [glossary](../../00-roadmap/glossary.md#core) |
| Satellite | Bucket **4** ≤20% | §4 | [glossary](../../00-roadmap/glossary.md#satellite) |
| Week gate | **퀴즈·산출물** 통과 | §4 | [glossary](../../00-roadmap/glossary.md#week-gate) |
| TAM | 거시 1단계 | §4 | [glossary](../../00-roadmap/glossary.md#tam) |
...
|             \(week\)             | week | week이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(read\)             | read | read이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(note\)             | note | note이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(quiz\)             | quiz | quiz이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(~\)   | \(~\) | \(~\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(시간\)   | \(시간\) | \(시간\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
|   5   |   **산출**: 본인 bucket 표 1장   | 5이(가) 이 식에서 맡는 역할(§4·본문 참고) |
### Week 2 — 반도체
