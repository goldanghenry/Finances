...
|   \(P_\)   | P  | P 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(DC\)             | DC | DC이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(N_\)   | N  | N 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(GPU\)             | GPU | GPU이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(PUE\)             | PUE | PUE이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
