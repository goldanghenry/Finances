...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(\R_\text{원화}\) | R  원화 | 본문 §4·위 식 맥락 참고 |
| \(\R_\text{달러}\) | R  달러 | 본문 §4·위 식 맥락 참고 |
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(\E_\text{Mag7}\) | E  Mag7 | 본문 §4·위 식 맥락 참고 |
| \(\w_\text{S&P}\) | w  S&P | 본문 §4·위 식 맥락 참고 |
| \(\s_\text{S&P}\) | s  S&P | 본문 §4·위 식 맥락 참고 |
| \(\w_\text{QQQ}\) | w  QQQ | 본문 §4·위 식 맥락 참고 |
| \(\s_\text{NDX}\) | s  NDX | 본문 §4·위 식 맥락 참고 |
| \(\w_\text{개별}\) | w  개별 | 본문 §4·위 식 맥락 참고 |
