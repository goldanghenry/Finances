...
|  Convexity  | Convexity | Convexity이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|  \(D_{Mac}\)  |  D Mac  | \(D Mac\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(CF_t\) | t기 현금흐름 | 유입 +, 유출 − (관례 확인) |
|  \(D_{mod}\)  |  D mod  | \(D mod\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
...
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(D_{mod}\)  |  D mod  | \(D mod\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(C_x\)  |  C x  | C x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(YTM_{corp}\)  |  YTM corp  | \(YTM corp\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(YTM_{gov}\)  |  YTM gov  | \(YTM gov\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
- **국고채 3·5·10년** — **벤치마크**·[주식 DCF](equity-valuation-fundamentals.md) \(r_f\)
- **회사채·금융채** — **그룹 리스크**·**교차보증**
