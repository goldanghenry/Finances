...
**이번 갱신 (2026-05-26)**: 독자 친화 일괄 보강 — **§0 선수 링크**, **§4a** 용어표, **§6 변수표→수식**, 본문 **`!!! info`** 첫등장 박스, **MathJax** 수식, **Phase 순서** 사이드바(nav), [READER-GUIDE](READER-GUIDE.md). 유지보수: `scripts/enrich_corpus.py` → `lint_reader_friendly.py` (CI 게이트).
