...
|   \(i_{t-1}\)   |   i_{t-1}   | \(i t-1\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(r_t\)  |  r t  | r t이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(i_t\)  |  i t  | i t이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\pi_{t\)  |  \pi t  | \(\pi t\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
**읽는 법**: **명목** 수익에서 **인플레**를 반영하면 **실질** 체감 수익을 본다. 정밀식은 본문 또는 §4 표를 따른다.
**유도 (L4)**:
1. **정의**: **r_t**, **i_t**, **pi_**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(y_{10}\)  |  y 10  | \(y 10\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
