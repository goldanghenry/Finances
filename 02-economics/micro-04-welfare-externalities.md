...
|             \(CS\)             | CS | CS이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(int\)             | int | int이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(Q\)             | Q | Q이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(bigl\)             | bigl | bigl이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(a\)             | a | a이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(b\)             | b | b이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(P\)   | 포트 규모 | 가상 포트폴리오 규모(만 원) |
|             \(bigr\)             | bigr | bigr이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\int_0\)  |  int 0  | int 0이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|            \(Q\)            | Q | Q이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
...
세수| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(Q_t\)  |  Q t  | Q t이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(T\) | 기간 | 마지막 CF 시점 |
|            \(Q\)            | Q | Q이(가) 이 식에서 맡는 역할(§4·본문 참고) |
