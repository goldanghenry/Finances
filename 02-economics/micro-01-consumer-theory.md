...
|   \(MRS_\)   | MRS  | MRS 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(xy\)             | xy | xy이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(dx\)             | dx | dx이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(dy\)             | dy | dy이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(Big\)             | Big | Big이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(u\)             | u | u이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|             \(bar\)             | bar | bar이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(MU_\)   | MU  | MU 이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\max_{x\)  |  \max x  | \(\max x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x\)  |  p x  | p x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y\)  |  p y  | p y이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
\[
\mathcal{L} = u(x,y) + \lamb| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x\)  |  p x  | p x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y\)  |  p y  | p y이(가) 이 식에서 맡는 역할(§4·본문 참고) |
da(m - p_x x - p_y y)
...
**읽는 법**: **p_x**와 **p_y**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **p_x**, **p_y**, **L**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
**읽는 법**: **p_x**와 **p_y**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **p_x**, **p_y**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
**유도**: 두 식을 나누면
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(MU_x}\)  |  MU x  | \(MU x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(MU_y}\)  |  MU y  | \(MU y\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x}\)  |  p x  | \(p x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y}\)  |  p y  | \(p y\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(MRS_{xy}\)  |  MRS xy  | \(MRS xy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
**읽는 법**: **MU_x**와 **MU_y**의 관계를 위 식으로 쓴다. 경제·재무 해석은 변수표 「이 식에서 의미」와 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 기호 예제를 맞춘다.
**유도 (L4)**:
1. **정의**: **MU_x**, **MU_y**, **p_x**를 동일 시점·동일 통화로 맞춘다. — 단위 불일치면 식이 무의미해진다.
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
...
|  \(p_x}\)  |  p x  | \(p x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x\)  |  p x  | p x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
탄력성**: \(\varepsilon_x = \frac{\partial x}| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x}\)  |  p x  | \(p x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x\)  |  p x  | p x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
{\partial p_x}\frac{p_x}{x} = -1\) (단일재 Cobb-Douglas \(x\) — **단위 탄력**).
...
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
**직관**: 가격↑ → (1) **대체**: | 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(r\) | 할인율·수익률 | 기간당 이자·요구수익률 |
| \(n\) | 기간 | 연·월 등 복리·할인에 쓰는 횟수 |
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |

\(x\) 대신 \(y\) (2) **소득**: 실질 구매력↓ → \(x\) 추가 감소(보통).
...
Cobb-Douglas: \(\eta_x = 1\) (지출 비율 \(\alpha\) 고정). \(\eta| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(lon_{xy}\)  |  lon xy  | \(lon xy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y}\)  |  p y  | \(p y\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
 > 1\): 사치재, \| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(lon_{xy}\)  |  lon xy  | \(lon xy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y}\)  |  p y  | \(p y\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
(\eta < 1\): 필수재.
...
\[
\varepsilon_{xy} = \frac{\partial x^*}{\partial p_y}\frac{p_y| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(r\) | 할인율·수익률 | 기간당 이자·요구수익률 |
| \(n\) | 기간 | 연·월 등 복리·할인에 쓰는 횟수 |
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
...
2. **식 변형**: 양변을 정리해 목표 변수를 한쪽에 둔다. — 할인·복리는 **시점 이동**이 핵심이다.
3. **해석**: 부호·크기가 경제 직관과 맞는지 확인한다. — 극단값에서 단조성·한계를 점검한다.
\(\varepsilon_{xy} > 0\): **대체재** ( \(y\) 가격↑ → \| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(lon_{xy}\)  |  lon xy  | \(lon xy\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(\min_{x\)  |  \min x  | \(\min x\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_x\)  |  p x  | p x이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(p_y\)  |  p y  | p y이(가) 이 식에서 맡는 역할(§4·본문 참고) |
