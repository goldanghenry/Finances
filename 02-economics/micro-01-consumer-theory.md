...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(MRS_\)  |  MRS_  | 본문 §4·위 식 맥락 참고 |
|  \(xy\)  |  xy  | 본문 §4·위 식 맥락 참고 |
|  \(dx\)  |  dx  | 본문 §4·위 식 맥락 참고 |
|  \(dy\)  |  dy  | 본문 §4·위 식 맥락 참고 |
|  \(Big\)  |  Big  | 본문 §4·위 식 맥락 참고 |
|  \(u\)  |  u  | 본문 §4·위 식 맥락 참고 |
|  \(bar\)  |  bar  | 본문 §4·위 식 맥락 참고 |
|  \(MU_\)  |  MU_  | 본문 §4·위 식 맥락 참고 |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(\max_{x\) | \max x | 본문 §4·위 식 맥락 참고 |
| \(p_x\) | p x | 본문 §4·위 식 맥락 참고 |
| \(p_y\) | p y | 본문 §4·위 식 맥락 참고 |
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(MU_x}\) | MU x | 본문 §4·위 식 맥락 참고 |
| \(MU_y}\) | MU y | 본문 §4·위 식 맥락 참고 |
| \(p_x}\) | p x | 본문 §4·위 식 맥락 참고 |
| \(p_y}\) | p y | 본문 §4·위 식 맥락 참고 |
| \(MRS_{xy}\) | MRS xy | 본문 §4·위 식 맥락 참고 |
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(p_x\) | p x | 본문 §4·위 식 맥락 참고 |
| \(p_x}\) | p x | 본문 §4·위 식 맥락 참고 |
