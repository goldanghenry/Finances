...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(CA\)  |  CA  | 본문 §4·위 식 맥락 참고 |
|  \(X\)  |  X  | 본문 §4·위 식 맥락 참고 |
|  \(M\)  |  M  | 가계 교육용 월 세후 소득 기호 |
|  \(NY\)  |  NY  | 본문 §4·위 식 맥락 참고 |
|  \(NT\)  |  NT  | 본문 §4·위 식 맥락 참고 |
\[
CA = (X - M) + NY + NT
\]
...
|------|------|----------------|
| \(P_d\) | P d | 본문 §4·위 식 맥락 참고 |
| \(P_w\) | P w | 본문 §4·위 식 맥락 참고 |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
| \(E\) | E | 본문 §4·위 식 맥락 참고 |
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
| \(P_w\) | P w | 본문 §4·위 식 맥락 참고 |
| \(P_d\) | P d | 본문 §4·위 식 맥락 참고 |
