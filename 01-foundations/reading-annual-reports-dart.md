...
|   **VI. 이사회 등의 의견**   |   배당·사채 등   | **VI. 이사회 등의 의견**이(가) 이 식에서 맡는 역할(§4·본문 참고) |
...
|   \(자산\)   | \(자산\) | \(자산\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(부채\)   | \(부채\) | \(부채\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|   \(자본\)   | \(자본\) | \(자본\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(r_{\text{변동}}\)  |  r \text변동  | \(r \text변동\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(PER_{\text{조정}}\)  |  PER \text조정  | \(PER \text조정\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
| \(EPS\) | 주당순이익 | 순이익 ÷ 발행주식수 |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
...
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(t_{\text{lag}}\)  |  t \textlag  | \(t \textlag\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(t_0\)  |  t 0  | t 0이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(t_1\)  |  t 1  | t 1이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(t_2\)  |  t 2  | t 2이(가) 이 식에서 맡는 역할(§4·본문 참고) |
ntro.md) 예제 4.
...
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(PV\) | 현재가치 | 오늘 시점으로 환산한 금액 |
|  \(m_i\)  |  m i  | m i이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(OP_i}\)  |  OP i  | \(OP i\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(Rev_i}\)  |  Rev i  | \(Rev i\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
| \(M\) | 월 실수령 | 가계 교육용 월 세후 소득 기호 |
| \(P\) | 포트 규모 | 가상 포트폴리오 규모(만 원) |
