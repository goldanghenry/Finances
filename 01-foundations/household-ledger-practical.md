...
- **발생**: 1월 E05 +12만 → 1월 지출 과대  
- **현금**: 2월 E05 +12만 → **2월 통장**과 일치 → **현금 마스터 채택**
...
승인월 3월에 36만 **한 번** 넣으면 **저축률 2·3월 왜곡**.

### 예제 3: 보너스 I02 300만 (가상)
...
\(\bar{U} = 11.3\) → 6월 예산 **12만**(×1.05 반올림) 또는 **14만**(max 버퍼).
