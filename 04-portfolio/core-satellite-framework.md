...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(w_{core}\)  |  w_{core}  | 본문 §4·위 식 맥락 참고 |
|  \(w_{sat}\)  |  w_{sat}  | 본문 §4·위 식 맥락 참고 |
...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(lta_{sell\) | lta sell | 본문 §4·위 식 맥락 참고 |
| \(w_{sat\) | w sat | 본문 §4·위 식 맥락 참고 |
| \(V\) | V | 본문 §4·위 식 맥락 참고 |
...
| \(FV_{core}\) | FV core | 본문 §4·위 식 맥락 참고 |
...
### 예제 1: 순자산 1억, 85/15 (가상 A)

| 구분 | 금액 | 구성 (전체 포트 대비) |
|------|------|----------------------|
| 코어 85% | 8,500만 | QQQ 35% + 글로벌 30% + 채권 20% |
