...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
|  \(Bucket 0\)  |  Bucket 0  | 본문 §4·위 식 맥락 참고 |
|  \(월 필수지출\)  |  월 필수지출  | 본문 §4·위 식 맥락 참고 |
|  \(N\)  |  N  | 연·월 등 복리·할인에 쓰는 횟수 |
|  \(sim\)  |  sim  | 본문 §4·위 식 맥락 참고 |
\[
...
**읽는 법**: 위 식의 기호는 바로 위 변수표와 같다. 숫자는 [DEPTH-STANDARD](../docs/DEPTH-STANDARD.md) 교육용 기호(M·P·PV 등)로 대입한다.
- **PMT**: Bucket 2b·3 월 적립 (ISA 자동이체 등)
...
| 단계 | 항목 | 월 행동 (가상) | 누적 (가상) |
|------|------|----------------|-------------|
| 1 | Bucket 0 | 지출 250만 × 6 = **1,500만** CMA | 1,500만 |
| 2 | Bucket 1 | 청년도약 월 70만 (5년, 규칙 준수) | +4,200만(원금) |
| 3 | Bucket 2a | DB — 회사 적립, **본인 매매 0** | 추계 퇴직금 별도 |
| 4 | Bucket 2b | ISA 월 100만 → QQQ·글로벌 | 10년 후 약 1.5억(5% 가정) |
| 5 | Bucket 3 | 2b 내 코어 85% / 위성 15% 상한 | — |
| 6 | Bucket 4 | NXT 장후 **월 20만 상한** | 연 240만 손실 한도 |

### 예제 2: 단기 자금 vs 단타 혼동 교정 (가상 B)

| 잘못된 설계 | 문제 | 교정 |
|-------------|------|------|
| 2년 뒤 전세 **3,000만**을 QQQ 100% | -30% 시 전세 못 냄 | **단기 자금** → 예금·단기채·MMF |
...
| 월 본인 적립 | ISA 80만 + IRP 50만 | DC 100만 + ISA 50만 |
