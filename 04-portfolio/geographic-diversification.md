...
| 기호 | 이름 | 이 식에서 의미 |
|       ------       | ------ | ------이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_p\)  |  R p  | R p이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{US}\)  |  w US  | \(w US\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{US}\)  |  R US  | \(R US\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(w_{GL}\)  |  w GL  | \(w GL\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
|  \(R_{GL}\)  |  R GL  | \(R GL\)이(가) 이 식에서 맡는 역할(§4·본문 참고) |
\[
