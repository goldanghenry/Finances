...
| 기호 | 이름 | 이 식에서 의미 |
|------|------|----------------|
| \(R_p\) | R p | 본문 §4·위 식 맥락 참고 |
| \(w_{US}\) | w US | 본문 §4·위 식 맥락 참고 |
| \(R_{US}\) | R US | 본문 §4·위 식 맥락 참고 |
| \(w_{GL}\) | w GL | 본문 §4·위 식 맥락 참고 |
| \(R_{GL}\) | R GL | 본문 §4·위 식 맥락 참고 |
