...
\[
|w - w^*| > \text{band} \Rightarrow \text{리밸런싱}
\]
...
| ISA 3년+ | **통산·한도** | 통산 | **간소** |
| IRP | **이연** | 이연 | 수령 시 |
| 일반 | **22%** | 금융소득 | **필수** — [part1](../06-korea-policy/tax/overseas-stocks-tax-part1-cgt.md) |
...
| | 전 | 후 |
|--|-----|-----|
| 위성 | 2,800만 (28%) | 2,000만 (20%) |
| 행동 | 코스닥·QLD **800만 매도** | 코어 채권·글로벌 **추가** |
